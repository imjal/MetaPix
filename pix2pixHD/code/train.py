...
from code.data_loader import create_k_txtfile_rand
...
def train(opt):
    ...
    if opt.mode == 'meta-train':
        ...
        opt.txtfile_img, opt.txtfile_label =  create_k_txtfile_rand(opt.txtfile_img, opt.txtfile_label, 
            opt.checkpoints_dir + "rand_k_img.txt", opt.checkpoints_dir + "rand_k_label.txt",  opt.k)
    ...
    for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
        ...
        for i, data in enumerate(dataset, start=epoch_iter):
            ...
            if total_steps % opt.print_freq == print_delta:
                ...
                visualizer.print_current_errors(epoch, epoch_iter, errors, t, total_loss_dict)
                visualizer.plot_current_errors(errors, total_steps, total_loss_dict)
